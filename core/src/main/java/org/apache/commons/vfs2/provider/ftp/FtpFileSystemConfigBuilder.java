...
public final class FtpFileSystemConfigBuilder extends FileSystemConfigBuilder
{
    ...
    private static final String ACTIVE_EXTERNAL_IP_ADDRESS = FtpFileSystemConfigBuilder.class.getName() + ".ACTIVE_EXTERNAL_IP_ADDRESS";
    private static final String REPORT_ACTIVE_EXTERNAL_IP_ADDRESS = FtpFileSystemConfigBuilder.class.getName() + ".REPORT_ACTIVE_EXTERNAL_IP_ADDRESS";
    private static final String ACTIVE_PORT_RANGE_MIN = FtpFileSystemConfigBuilder.class.getName() + ".ACTIVE_PORT_RANGE_MIN";
    private static final String ACTIVE_PORT_RANGE_MAX = FtpFileSystemConfigBuilder.class.getName() + ".ACTIVE_PORT_RANGE_MAX";
