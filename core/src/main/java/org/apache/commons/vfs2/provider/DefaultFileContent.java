...
public final class DefaultFileContent implements FileContent
{
    ...
    */
    ...
    /**
     * Returns an output stream without loading the file system
     * @return The OutputStream for the file.
     * @throws FileSystemException if an error occurs.
     */
    public OutputStream getDirectOutputStream() throws FileSystemException
    {
        ...
        // Get the raw output stream
        final OutputStream outstr = fileObject.getDirectOutputStream();
    ...
    private void endOutput() throws Exception
    {
     ...
     // Celigo Patch 1/30/2018: do not refresh file system
